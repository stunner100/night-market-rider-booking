...
const AIChatWidget = {
  ...
  createWidget() {
    ...
    widget.innerHTML = `
      ...
      <!-- Chat Window -->
      <div id="ai-chat-window" class="fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-48px)] bg-surface-dark border border-white/10 rounded-2xl shadow-2xl overflow-hidden transform scale-0 opacity-0 origin-bottom-right transition-all duration-300">
        <!-- Header -->
        <div class="bg-brand-yellow text-black p-4 flex items-center gap-3">
        ...
        <!-- Messages -->
        <div id="ai-chat-messages" class="h-[350px] overflow-y-auto p-4 space-y-4 scroll-smooth">
          <!-- Welcome message -->
